  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div
          className={`mx-auto flex w-full min-h-0 flex-1 items-start gap-4 pb-24 pt-4 lg:pb-6 ${LAYOUT_CLASSES.pagePadding}`}
          style={{ maxWidth: `${LAYOUT_MAX_WIDTH}px` }}
        >
          <LeftNav />
          <main className="relative min-h-0 flex-1 overflow-y-auto rounded-2xl bg-black/35 px-4 pb-24 pt-6 shadow-2xl backdrop-blur-xl sm:pb-12 lg:px-8">
            <MainView />
          </main>
        </div>
      </div>
